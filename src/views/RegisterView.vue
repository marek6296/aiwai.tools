      ...
      <div class="auth-card glass">
        ...
        <div v-if="registered" class="success-state">
          <div class="success-icon">
            <PhCheckCircle :size="56" weight="thin" />
          </div>
          ...
          <router-link to="/login" class="auth-submit" style="text-decoration: none; margin-top: 1.5rem;">
            <PhSignIn :size="18" />
            Prihlásiť sa
          </router-link>
        </div>
        ...
        <template v-else>
          <div class="auth-header">
            ...
            <p class="auth-subtitle">Zadarmo, bez záväzkov</p>
          </div>
          ...
          <form class="auth-form" @submit.prevent="handleRegister">
            <div class="field-group">
              ...
              <div class="field-wrap" :class="{ focused: nameFocused }">
                <PhUser :size="16" class="field-icon" />
                <input
                  type="text"
                  v-model="fullName"
          ...
          <router-link to="/login" class="auth-alt-btn">
            Prihlásiť sa
          </router-link>
        </template>
      </div>
...
import { PhEnvelope, PhLock, PhEye, PhEyeSlash, PhWarning, PhUser, PhUserPlus, PhCheckCircle, PhSignIn } from '@phosphor-icons/vue'
