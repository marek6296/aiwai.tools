...
const categories = [
  ...
  { name: 'AI Nástroje', href: '/ai', internal: true },
  { name: 'Médiá & Konverzie', href: '/media', internal: true },
  { name: 'Foto & Dizajn', href: '/design', internal: true },
  { name: 'Text & Písanie', href: '/text', internal: true },
  { name: 'Kód & Technológie', href: '/dev', internal: true },
  { name: 'Škola & Veda', href: '/edu', internal: true },
  { name: 'Cestovanie', href: '/travel', internal: true },
  { name: 'Marketing & Sociálne', href: '/marketing', internal: true },
  { name: 'Financie & Biznis', href: '/finance', internal: true },
  { name: 'Zábava & Fun', href: '/fun', internal: true },
