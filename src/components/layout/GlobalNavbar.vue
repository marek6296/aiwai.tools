...
const categories = [
  ...
  { name: 'n8n Návody', href: '/ai', internal: true },
  { name: 'Make Workflow', href: '/ai', internal: true },
  { name: 'AI Agenti', href: '/ai', internal: true },
  { name: '—', href: '#', internal: true },
  { name: 'AI Nástroje', href: '/ai', internal: true },
  { name: 'Text & Písanie', href: '/text', internal: true },
  { name: 'Marketing', href: '/marketing', internal: true },
  { name: 'Kód & Dev', href: '/dev', internal: true },
